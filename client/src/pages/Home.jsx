      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <button
              className="md:hidden text-gray-600 dark:text-gray-400 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 space-y-3 border-t border-gray-200 dark:border-gray-700">
              <a
                href="#features"
                className="block text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors px-4 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700"
      ...
      <main>
        <section className="relative pt-32 pb-20 px-4 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
          <div className="relative max-w-4xl mx-auto text-center z-10">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6 leading-tight text-gray-900 dark:text-gray-100">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center bg-white dark:bg-gray-700 rounded-xl p-2 border border-gray-300 dark:border-gray-600 shadow-lg gap-2 sm:gap-0">
