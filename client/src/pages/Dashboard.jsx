  ...
  if (loading) {
    return (
      <div className="text-center py-12" role="status" aria-live="polite">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your ideas...</p>
      </div>
    );
  }
    ...
    <div className="animate-fade-in">
      ...
      {ideas.length === 0 ? (
        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600 transition-colors">
          <Lightbulb className="inline-block h-16 w-16 text-gray-400 dark:text-gray-500 mb-4" aria-hidden="true" />
          <p className="text-gray-600 dark:text-gray-400 text-lg mb-4">No ideas yet. Create your first one!</p>
          <Link
            to="/create"
